...
RSpec.describe Todo, type: :model do
  ...
  describe "validations" do
    it "is valid with a title" do
      todo = Todo.new(title: "Write tests", description: "Add RSpec coverage", completed: false, user: user, priority: :medium)
  ...
  describe "associations" do
    it "can have comments and subtasks" do
      todo = Todo.create!(title: "With relations", user: user)
